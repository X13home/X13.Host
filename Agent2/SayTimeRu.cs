...
namespace X13.Agent2 {
  internal class SayTimeRu {
    ...
    public SayTimeRu(){
      ...
      DTNow=DateTime.Now;
      hour=DTNow.Hour;
      Interval=60000*(59-DTNow.Minute)+1000*(60-DTNow.Second);
      ...
      t=new Timer(timeCB, (object)true, Interval, Timeout.Infinite);
    }
    public void SayTime() {
    ...
    private void SayTimeThread(object fl) {
      ...
      int Interval=60000*(59-min)+1000*(61-DTNow.Second);
